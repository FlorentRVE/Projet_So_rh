        ...
        ->add('code', ChoiceType::class, [
            ...
            'choices' => [
                    ...
                    'Autres' => [
                        ...
                        'Fait à ... le' => '<div class="flex flex-wrap font-semibold gap-4"><div class="flex flex-col gap-2 flex-1"><label for="fait_a" class="text-slate-50">Fait à :</label><input type="text" id="fait_a" name="fait_a" placeholder="Fait à ..." class="rounded-lg p-4"></input></div><div class="flex flex-col gap-2 flex-1"><label for="le" class="text-slate-50">le :</label><input type="le" name="le" id="le" class="rounded-lg p-4"></div></div>',
