        ...
        ->add('code', ChoiceType::class, [
            ...
            'choices' => [
                    ...
                    'Autres' => [
                        ...
                        'Fait à ... le' => '<div class="flex flex-wrap font-semibold gap-4"><div class="flex flex-col gap-2 flex-1"><label for="faita" class="text-slate-50">Fait à :</label><input type="text" id="faita" name="faita" placeholder="Fait à ..." class="rounded-lg p-4"></input></div><div class="flex flex-col gap-2 flex-1"><label for="date" class="text-slate-50">le :</label><input type="date" name="date" id="date" class="rounded-lg p-4"></div></div>',
