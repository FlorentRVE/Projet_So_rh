        ...
        ->add('code', ChoiceType::class, [
            ...
            'choices' => [
                    ...
                    'Demande' => [
                        ...
                        'Ma demande concerne ...' => '<div class="flex flex-col gap-2 flex-1"><label for="demandepour" class="text-slate-50">Demande pour :</label><select id="demandempour" name="demandepour" class="rounded-lg w-[50%] p-2"><option value="paie">La Paie</option><option value="formation">La Formation</option><option value="administratif">Mon dossier Administratif</option><option value="autres">Autres</option></select></div>',
                    ...
                    'Autres' => [
                        ...
                        'Fait à ... le' => '<div class="flex flex-wrap font-semibold gap-4"><div class="flex flex-col gap-2 flex-1"><label for="fait_a" class="text-slate-50">Fait à :</label><input type="text" id="fait_a" name="fait_a" placeholder="Fait à ..." class="rounded-lg p-4"></input></div><div class="flex flex-col gap-2 flex-1"><label for="datele" class="text-slate-50">Le :</label><input type="date" name="datele" id="datele" class="rounded-lg w-[50%] p-2"></div></div>',
                        'Comment récupérer mon document ...' => '<div class="flex flex-col gap-2 flex-1"><label for="adresse" class="text-slate-50">Je souhaite récupérer mon document :</label><div class="flex gap-4"><label for="surplace" class="text-slate-50"><input type="radio" id="surplace" name="adresse" value="surplace" class="rounded-lg p-4">Sur place</label><label for="parmail" class="text-slate-50"><input type="radio" id="parmail" name="adresse" value="parmail" class="rounded-lg p-4">Par mail</label></div></div>',
                    ],
                ]])
                ->add('label', null, [
