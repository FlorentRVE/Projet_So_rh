    ...
    {  
        ...
        ->add('code', ChoiceType::class, [
            ...
            'choices' => [
                    ...
                    'Demande duplicata bulletin salaire' => '<div class="flex flex-col gap-2 flex-1"><p class="text-slate-50">Je souhaite recevoir le duplicata de mon bulletin de salaire du mois :</p><div class="flex gap-4"><div class="flex flex-col gap-2 flex-1"><label for="datedu" class="text-slate-50">Du :</label><input type="date" name="datedu" id="datedu" class="rounded-lg p-2"></div><div class="flex flex-col gap-2 flex-1"><label for="dateau" class="text-slate-50">Au :</label><input type="date" name="dateau" id="dateau" class="rounded-lg p-2"></div></div></div>',
